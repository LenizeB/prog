       ...
       do {
           ...
           switch (opcao)
        {
            ...
            case "10" :
            {
                ...
                batatinha.Dados(batata, dinheiro1);
            ...
            case "11" :
            {
                ...
                "4.\bPode apostar em par ou ímpar com" +
                "pagamento de 1 para 1.");
                ...
                switch (sl)
                {
                    ...
                    case 2 : 
                    {
                        ...
                        batatinha.Roleta2(op1, num1, money1);
                        JOptionPane.showMessageDialog(null,"O NÚMERO SORTEADO FOI:" + batatinha.num);
                        break;
                    ...
                    case 3 :
                    {
                        ...
                        batatinha.Roleta3(op2, num2, money2);
                        JOptionPane.showMessageDialog(null,"O NÚMERO SORTEADO FOI:" + batatinha.num);
                        break;
                    }
